...
var colors = (_colors = {
  ...
  messenger: '#0084ff',
  reddit: '#ff4500'
}, _defineProperty(_colors, "danger", '#DB2828'), _defineProperty(_colors, "success", '#5cb85c'), _defineProperty(_colors, "blackbaud", '#8cbe4f'), _defineProperty(_colors, "everydayhero", '#1bab6b'), _defineProperty(_colors, "justgiving", '#ad29b6'), _colors);
/**
 * Fonts
 */
...
var treatments = {
  ...
  input: {
    ...
    fontSize: '1rem',
    borderRadius: '3px',
    border: "solid 1px ".concat(colors.gray03)
  },
  select: {
    fontFamily: fonts.body,
    fontSize: '1rem',
      ...
      _createClass(ConnectStyles, [{
        ...
        value: function render() {
          ...
          if (_typeof(this.props.classNames) === 'object') {
            ...
            return React.createElement(ComponentToWrap, _newProps);
          ...
          return React.createElement(ComponentToWrap, newProps);
        }
      }]);
...
var Icon = function Icon(_ref) {
  ...
  return React.createElement("svg", {
    ...
    return React.createElement("path", _extends({}, pathProps, {
      key: i
    }));
  }));
};
...
var styles$1 = (function (_ref, _ref2) {
  ...
  var borderStyles = border ? {
    ...
    border: "1px solid ".concat(colors.gray01),
...
var Accordion = function Accordion(_ref) {
  ...
  }, toggled ? opened : closed)), React.createElement("div", {
...
Accordion.defaultProps = {
  ...
  color: 'primary',
  font: 'head',
  opened: React.createElement(Icon$1, {
    name: "dropdown",
    rotate: 180
  }),
  closed: React.createElement(Icon$1, {
    name: "dropdown"
  }),
  styles: {}
};
...
var ButtonShare = function ButtonShare(_ref) {
  var share = _ref.share,
      ...
      image = _ref.image,
      props = _objectWithoutProperties(_ref, ["share", "text", "type", "url", "title", "hashtags", "image"]);
...
var index$1 = (function (props) {
  ...
  return React.createElement(ButtonShare, props);
});
 ...
 * of values.
 */
var objectToString$1 = objectProto$h.toString;
...
var require$$5 = getCjsExportFromNamespace(ResizeObserver_es);
...
var _resizeObserverPolyfill = _interopRequireDefault(require$$5);
...
var PaginationLink = function PaginationLink(_ref) {
  ...
  }, props), React.createElement(Icon$1, {
    name: icon,
...
var Carousel = function Carousel(_ref) {
  ...
  var allowedProps = pick_1(props, propsWhitelist.forEach(function (e) {
    return e;
  }));
  return React.createElement("div", {
    className: "c11n-carousel ".concat(classNames.root)
  }, React.createElement(Slider, _extends({
    prevArrow: React.createElement(PaginationLink$1, {
      direction: "prev"
    }),
    nextArrow: React.createElement(PaginationLink$1, {
      direction: "next"
    })
  }, allowedProps), children));
};
...
var index$3 = compose(withStyles(styles$4))(Carousel);
...
var index$4 = (function (props) {
  ...
  return React.createElement(PaginationLink$1, props);
});
...
var index$5 = withStyles(styles$6)(Container);
...
var index$6 = withStyles(styles$7)(Filter);
...
var index$7 = withStyles(styles$8)(Flippy);
...
var Form = function Form(_ref) {
  ...
  var renderIcon = function renderIcon(icon) {
    return _typeof(icon) === 'object' ? React.createElement(Icon$1, _extends({
      styles: styles.icon
  ...
  return React.createElement("form", _extends({
  ...
  }), actions.length ? React.createElement(ButtonGroup$1, {
    styles: styles.actions
  }, submit && React.createElement(Button$1, {
    styles: styles.submit,
    disabled: isLoading || isDisabled,
    "aria-label": submit,
    title: submit,
    type: "submit"
  }, React.createElement("span", null, submit), icon && renderIcon(icon)), actions.map(function (_ref2, i) {
    ...
    return React.createElement(Button$1, _extends({
      ...
      "aria-label": label,
      title: submit
    }, actionProps), React.createElement("span", null, label), icon && renderIcon(icon));
  })) : submit ? React.createElement(Button$1, _extends({
    block: true,
    styles: styles.submit,
    disabled: isLoading || isDisabled,
    "aria-label": submit,
    title: submit,
    type: "submit"
  }, submitProps), React.createElement("span", null, submit), icon && renderIcon(icon)) : null, footer);
};
...
var index$8 = withStyles(styles$9, keyframes$2)(Form);
...
var index$9 = withStyles(styles$a)(Grid);
...
var index$a = withStyles(styles$b)(GridColumn);
...
var index$b = withStyles(styles$c)(Heading);
...
var index$c = withStyles(styles$d)(Image);
...
var InputField = function InputField(_ref) {
  ...
  }, label && React.createElement(Label$1, {
    id: labelId,
    inputId: inputId,
    required: required,
    styles: {
  ...
  }, label), renderField(), status && renderStatus(), error && React.createElement(InputValidations$1, {
    styles: {
      root: styles.error
    },
...
var InputSelect = function InputSelect(_ref) {
    ...
    if (groupOptions) {
      ...
      mapKeys_1(groupedOptions, function (opts, groupLabel) {
        if (groupLabel !== 'undefined') {
          resultOptions.push(React.createElement("optgroup", {
            key: groupLabel,
            label: groupLabel
  ...
  return React.createElement("div", {
    ...
    required: true,
    "aria-labelledby": labelId
  }, allowedProps), placeholder && React.createElement("option", {
    disabled: true,
    value: ""
  }, placeholder), renderOptions()), React.createElement("span", {
    className: classNames.field,
    "aria-hidden": true
  }), React.createElement(Icon$1, {
    name: "dropdown",
    size: 0.75,
    styles: styles.icon
  })), error && React.createElement(InputValidations$1, {
    styles: {
      root: styles.error
    },
    validations: validations
...
function (_Component) {
  ...
  _createClass(InputDate, [{
    ...
    value: function render() {
      ...
      return showSelects ? React.createElement("div", {
        ...
        className: classNames.wrapper
      }, React.createElement(InputSelect$1, _extends({}, allowedProps, {
        styles: styles.input,
        ...
        validations: validations
      })) : React.createElement(InputField$1, _extends({
        type: "date"
      }, this.props));
    }
  }]);
...
var index$d = withStyles(styles$e)(InputDate);
...
function (_Component) {
  ...
  _createClass(InputFile, [{
    key: "handleUpdate",
    value: function handleUpdate(_ref, method) {
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          validations = _this$props.validations,
          props = _objectWithoutProperties(_this$props, ["classNames", "button", "error", "icon", "id", "label", "name", "required", "placeholder", "onBlur", "onChange", "styles", "value", "validations"]);

      var files = this.state.files;
      var filesCount = files.length;
      var propsBlacklist = ['children', 'dirty', 'initial', 'invalid', 'styles', 'touched', 'validators', 'value'];
      var allowedProps = omit_1(props, propsBlacklist);
      var inputId = id || name;
      var labelId = "label-".concat(inputId);
      ...
      var renderField = function renderField() {
        return React.createElement("div", {
          ...
          id: inputId,
          onChange: function onChange(e) {
            return _this2.handleUpdate(e, _onChange);
          },
          onBlur: function onBlur(e) {
            return _this2.handleUpdate(e, _onBlur);
          },
          required: required,
          "aria-labelledby": labelId
        }, allowedProps)), React.createElement(Button$1, _extends({
          styles: styles.field
        }, button), icon && React.createElement(Icon$1, {
          name: icon
        }), filesCount ? filesCount > 1 ? React.createElement("span", null, filesCount, " files selected") : React.createElement("span", null, files[0].name) : React.createElement("span", null, placeholder)));
      };
      ...
      }, label), renderField(), error && React.createElement(InputValidations$1, {
        styles: {
          root: styles.error
        },
        validations: validations
...
var index$e = withStyles(styles$j)(InputFile);
...
var styles$k = (function (_ref, _ref2) {
  var invalid = _ref.invalid,
      readOnly = _ref.readOnly,
      styles = _ref.styles,
      touched = _ref.touched,
...
var styles$l = (function (props, traits) {
...
var Section$1 = withStyles(styles$m)(Section);
...
var InputSearchResult$1 = withStyles(styles$l)(InputSearchResult);
...
var DefaultResultComponent = function DefaultResultComponent(_ref2) {
  var isActive = _ref2.isActive,
      result = _ref2.result;
  return React.createElement(InputSearchResult$1, {
    isActive: isActive
  }, result.label);
};
...
function (_Component) {
  ...
  _createClass(InputSearch, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
      ...
      }, valueFormatter(value)), React.createElement("div", {
        ...
        status: status,
        toShow: toShow
      }, showMore && results.length > toShow && React.createElement("button", {
        type: "button",
        className: classNames.showMore,
        onClick: this.showMore
      }, React.createElement("span", null, "Load More"), ' ', React.createElement(Icon$1, {
        name: "chevron",
        rotate: 90,
        size: 0.75
      }))))), error && React.createElement(InputValidations$1, {
...
var index$f = compose(withStyles(styles$k), onClickOutsideHOC)(InputSearch);

var styles$n = (function (_ref, _ref2) {
  var styles = _ref.styles,
      theme = _ref.theme,
...
var styles$o = (function (_ref, _ref2, keyframes) {
  var color = _ref.color,
      size = _ref.size,
...
var Loading$1 = withStyles(styles$o, keyframes$3)(Loading);
...
function (_React$Component) {
  ...
  _createClass(LazyImage, [{
    ...
    value: function render() {
      ...
      var spinner = children || React.createElement(Loading$1, loadingProps);
      return React.createElement("div", {
...
var index$g = withStyles(styles$n)(LazyImage);
...
var index$h = withStyles(styles$p)(Leaderboard);
...
var LeaderboardItem = function LeaderboardItem(_ref) {
  ...
  }, React.createElement(LinkTag, _extends({
    href: href,
    target: target,
    rel: target === '_blank' ? 'noopener' : undefined
  }, linkProps), React.createElement("div", {
    className: classNames.link
  }, rank && React.createElement("div", {
    className: classNames.rank
  }, rank), image && React.createElement("img", {
    src: image,
    alt: title,
  ...
  }, subtitle)), amount && React.createElement("div", {
...
var index$i = withStyles(styles$q)(LeaderboardItem);
...
var Metric = function Metric(_ref) {
  ...
  }, renderIcon(), label && React.createElement("div", {
    className: classNames.label
  }, label), amount && React.createElement("div", {
    className: classNames.amount
  }, amount));
};
...
var index$j = withStyles(styles$r)(Metric);
...
var index$k = withStyles(styles$s)(MetricGroup);
...
var RichText = function RichText(_ref) {
  ...
  }, typeof children === 'string' ? React.createElement("span", {
...
var RichText$1 = withStyles(styles$t)(RichText);
...
var styles$u = (function (_ref, _ref2) {
  ...
  var defaultStyles = {
    ...
    close: (_close = {
      ...
      right: rhythm(0.75),
      border: 'none'
    }, _defineProperty(_close, "top", '20px'), _defineProperty(_close, "outline", 'none'), _close),
    h5: {
      margin: '0',
      fontWeight: '500',
      textTransform: 'uppercase'
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["appElement", "children", "closeIcon", "classNames", "title", "styles"]);
      ...
      }, props), closeIcon && React.createElement("button", {
      ...
      }, React.createElement(Section$1, {
        className: "modal-header"
      }, React.createElement(RichText$1, {
        styles: {
          '& h5': {
            margin: '0',
            fontWeight: '500',
      ...
      }, React.createElement("h5", null, title))), React.createElement(Section$1, {
...
Modal.defaultProps = {
  ...
  closeIcon: React.createElement(Icon$1, {
    name: "close"
  }),
  shouldCloseOnOverlayClick: true,
  spacing: 1,
...
var index$l = withStyles(styles$u)(Modal);
...
var NumberToWords = function NumberToWords(_ref) {
  ...
  return React.createElement(Tag, props, numberToWords(number));
};
...
function customDefaultsAssignIn(objValue, srcValue, key, object) {
  if (objValue === undefined ||
      (eq_1(objValue, objectProto$k[key]) && !hasOwnProperty$h.call(object, key))) {
    return srcValue;
  }
  return objValue;
}
...
var index$m = withStyles(styles$v)(ProgressBar);
...
function (_Component) {
  ...
  _createClass(SearchForm, [{
    ...
    value: function render() {
      ...
      }, button)))), children && React.createElement("div", {
        className: classNames.results
      }, children));
    }
  }]);
...
var index$n = compose(withToggle, withStyles(styles$w))(SearchForm);
...
var SearchResult = function SearchResult(_ref) {
  ...
  return React.createElement("li", {
  ...
  }, image && React.createElement("div", null, React.createElement("img", {
    src: image,
    alt: title,
    ...
    className: classNames.title
  }, title), subtitle && React.createElement("h6", {
    className: classNames.subtitle
  }, subtitle)), React.createElement("div", null, React.createElement(Button$1, _extends({
    tag: "a",
    href: url,
    "aria-label": cta,
    children: cta,
...
var index$o = withStyles(styles$x)(SearchResult);

var styles$y = (function (_ref, _ref2) {
  var styles = _ref.styles;
  var rhythm = _ref2.rhythm,
      scale = _ref2.scale,
      justifyContent = _ref2.justifyContent;
...
var index$p = withStyles(styles$y)(SearchResults);
...
var styles$z = (function (_ref, _ref2, keyframes) {
  var background = _ref.background,
      foreground = _ref.foreground,
...
var index$q = withStyles(styles$z, keyframes$4)(Ticker);
  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      var TooltipPortal$1 = function TooltipPortal$1(props) {
        return hovering ? React.createElement(TooltipPortal, props) : null;
      };
...
export { index as Accordion, Button$1 as Button, ButtonGroup$1 as ButtonGroup, ButtonShare, index$1 as ButtonSocial, index$3 as Carousel, index$4 as CarouselArrow, index$5 as Container, index$6 as Filter, index$7 as Flippy, index$8 as Form, index$9 as Grid, index$a as GridColumn, index$b as Heading, Icon$1 as Icon, index$c as Image, index$d as InputDate, InputField$1 as InputField, index$e as InputFile, index$f as InputSearch, InputSearchResult$1 as InputSearchResult, InputSelect$1 as InputSelect, InputValidations$1 as InputValidations, Label$1 as Label, index$g as LazyImage, index$h as Leaderboard, index$i as LeaderboardItem, Loading$1 as Loading, Meta, index$j as Metric, index$k as MetricGroup, index$l as Modal, NumberToWords, Pagination, PaginationLink$1 as PaginationLink, index$m as ProgressBar, RichText$1 as RichText, index$n as SearchForm, index$o as SearchResult, index$p as SearchResults, Section$1 as Section, index$q as Ticker, Tooltip, TraitsProvider, Typekit, withForm, withStyles, withToggle };

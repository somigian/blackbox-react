(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('crypto'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'crypto', 'react-dom'], factory) :
  (global = global || self, factory(global.blackboxReactComponentsLibrary = {}, global.React, global.crypto, global.reactDom));
}(this, function (exports, React, crypto, reactDom) { 'use strict';
  ...
  */
  ...
  var ButtonShare = function ButtonShare(_ref) {
    ...
    return React__default.createElement(Button$1, _extends({
      ...
      name: type
    }), text && React__default.createElement("span", null, text));
  };
      ...
      value: function render() {
        ...
        var renderField = function renderField() {
          return React__default.createElement("div", {
            ...
            required: required,
            "aria-labelledby": labelId
          }, allowedProps)), React__default.createElement(Button$1, _extends({
            styles: styles.field
          }, button), icon && React__default.createElement(Icon$1, {
            name: icon
          }), filesCount ? filesCount > 1 ? React__default.createElement("span", null, filesCount, " files selected") : React__default.createElement("span", null, files[0].name) : React__default.createElement("span", null, placeholder)));
        };
        ...
        }, label), renderField(), error && React__default.createElement(InputValidations$1, {
          styles: {
            root: styles.error
          },
          validations: validations
  ...
  */
  ...
  function (_Component) {
    ...
    _createClass(Modal, [{
      ...
      value: function render() {
        ...
        }, React__default.createElement(Section$1, {
          className: "modal-header"
        }, React__default.createElement(RichText$1, {
          styles: {
            '& h5': {
              margin: '0',
              fontWeight: '500',
        ...
        }, React__default.createElement("h5", null, title))), React__default.createElement(Section$1, {
  ...
  exports.CarouselArrow = index$4;
  exports.Container = index$5;
  exports.Filter = index$6;
  exports.Flippy = index$7;
  exports.Form = index$8;
  exports.Grid = index$9;
  exports.GridColumn = index$a;
  exports.Heading = index$b;
  exports.Icon = Icon$1;
  exports.Image = index$c;
  exports.InputDate = index$d;
  exports.InputField = InputField$1;
  exports.InputFile = index$e;
  exports.InputSearch = index$f;
  ...
  exports.LazyImage = index$g;
  exports.Leaderboard = index$h;
  exports.LeaderboardItem = index$i;
  exports.Loading = Loading$1;
  exports.Meta = Meta;
  exports.Metric = index$j;
  exports.MetricGroup = index$k;
  exports.Modal = index$l;
  exports.NumberToWords = NumberToWords;
  exports.Pagination = Pagination;
  exports.PaginationLink = PaginationLink$1;
  exports.ProgressBar = index$m;
  exports.RichText = RichText$1;
  exports.SearchForm = index$n;
  exports.SearchResult = index$o;
  exports.SearchResults = index$p;
  exports.Section = Section$1;
  exports.Ticker = index$q;
